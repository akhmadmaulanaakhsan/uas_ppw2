...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('buku.search') }}" method="get">
            @csrf
            <input type="text" name="kata" class="form-control" placeholder="Cari ..." style="width: 30%; display: inline; margin-bottom: 10px; float: right" />
        </form>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('buku.edit', $buku->id) }}" style="display: inline">
                            @csrf
                            @method('PUT')
